...
class DisplayForm extends StatefulWidget {
  final core.FormElementProvider formElementProvider =
  core.FormElementProvider();
...
class _DisplayFormState extends State<DisplayForm> {
  ...
  Future<void> loadElements(form) async {
    ...
    if (form.loadingStatus == core.LoadingStatus.idle) {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      widget.form.loadingStatus = core.LoadingStatus.idle;
  ...
  Widget formBody(core.Form form) {
    var sendForm = () {
    ...
    switch (form.loadingStatus) {
      case core.LoadingStatus.ready:
        ...
        return Column(children: [
          ...
          ...inputs,
          longButtons(AppLocalizations.of(context)!.saveData, sendForm),
        ]);
      default:
        if (form.loadingStatus == core.LoadingStatus.idle &&
